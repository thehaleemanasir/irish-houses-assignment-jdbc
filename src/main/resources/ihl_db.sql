CREATE DATABASE  IF NOT EXISTS `ihl_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ihl_db`;
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: ihl_db
-- ------------------------------------------------------
...
CREATE TABLE `properties` (
  ...
  KEY `fk_garageId` (`garageId`),
  KEY `fk_agentId` (`agentId`),
  CONSTRAINT `fk_properties_agents` FOREIGN KEY (`agentId`) REFERENCES `agents` (`agentId`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_properties_garagetypes` FOREIGN KEY (`garageId`) REFERENCES `garagetypes` (`garageId`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_properties_propertytypes` FOREIGN KEY (`typeId`) REFERENCES `propertytypes` (`typeId`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_properties_styles` FOREIGN KEY (`styleId`) REFERENCES `styles` (`styleId`) ON DELETE SET NULL ON UPDATE CASCADE
...
--
-- Dumping routines for database 'ihl_db'
--
...
-- Dump completed on 2024-08-24 10:59:54
